...
افتح **http://localhost:3210** واستخدم كلمة المرور الناتجة. لا تحتاج حساب ChatGPT أو استضافة Sites أو خدمة سحابية لتشغيل هذه النسخة. يعمل الموقع على جهاز Linux المحلي؛ الوصول إليه من جهاز آخر يحتاج إعداد نشر HTTPS منفصلاً.
